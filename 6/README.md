...
## cpu load
```UTC 20:10 until 02:10: stress -v --cpu 8 --io 8 -t 21600```
...
![Alt text](Experiment6.svg?raw=true "Complete Experiment")

![Alt text](Experiment6Details.svg?raw=true "Details 1")