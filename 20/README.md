...
## cpu load
```until 17:55: stress -v --cpu 8 --io 8 -t 14400```
...
![Alt text](Experiment20.svg?raw=true "Complete Experiment")

![Alt text](Experiment20Details.svg?raw=true "Details 1")
