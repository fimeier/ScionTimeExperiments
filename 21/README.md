...
## cpu load
```until 02:05: stress -v --cpu 8 --io 8 -t 14400```
...
![Alt text](Experiment21.svg?raw=true "Complete Experiment")

![Alt text](Experiment21Details.svg?raw=true "Details 1")
